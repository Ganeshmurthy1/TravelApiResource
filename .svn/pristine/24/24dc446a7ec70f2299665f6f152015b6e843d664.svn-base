...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.model.OTAHotelAvailRQ.AvailRequestSegments.class
})
public class AvailRequestSegmentsType
    implements Serializable
{

    public void setAvailRequestSegments(List<AvailRequestSegmentsType.AvailRequestSegment> availRequestSegments) {
