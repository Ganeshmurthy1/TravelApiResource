    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<String> videoUrlLists;
        ...
        /**
         * Gets the value of the videoUrlLists property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the videoUrlLists property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getVideoUrlLists().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<String> getVideoUrlLists() {
            if (videoUrlLists == null) {
                videoUrlLists = new ArrayList<String>();
            }
            return this.videoUrlLists;
        }
