...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.book.model.HotelReservationsType.HotelReservation.class,
    com.tayyarah.api.hotel.travelguru.book.model.HotelResModifyType.HotelResModify.class
})
