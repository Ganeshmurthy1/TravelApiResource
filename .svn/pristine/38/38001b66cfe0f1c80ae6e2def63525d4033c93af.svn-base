package com.tayyarah.misellaneous.entity;
...
@Entity
@Table(name = "miscellaneous_order_row_service_tax")
public class MiscellaneousOrderRowServiceTax extends Timestampable implements Serializable {
