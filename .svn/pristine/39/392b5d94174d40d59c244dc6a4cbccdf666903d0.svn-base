...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.book.model.AllianceConsortiumType.AllianceMember.class,
    CompanyNamePrefType.class,
    OperatingAirlineType.class,
    com.tayyarah.api.hotel.travelguru.book.model.DirectBillType.CompanyName.class,
    TravelArrangerType.class,
    com.tayyarah.api.hotel.travelguru.book.model.ContactInfoType.CompanyName.class
})
