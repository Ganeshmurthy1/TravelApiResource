 ...
 *         &lt;element name="BaseWithoutMarkUp" type="{http://www.opentravel.org/OTA/2003/05}TotalType" minOccurs="0"/>
...
@XmlSeeAlso({
	com.tayyarah.hotel.model.RateType.Rate.class
})
...
implements Serializable
{
	...
	/**
	 * @return the alternateCurrencyInd
	 */
	...
	/**
	 * @return the expireDateExclusiveIndicator
	 */
