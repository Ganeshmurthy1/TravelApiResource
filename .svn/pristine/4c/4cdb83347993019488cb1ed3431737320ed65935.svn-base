...
@XmlSeeAlso({
    com.tayyarah.hotel.model.AllianceConsortiumType.AllianceMember.class,
    CompanyNamePrefType.class,
    OperatingAirlineType.class,
    com.tayyarah.hotel.model.DirectBillType.CompanyName.class,
    TravelArrangerType.class,
    com.tayyarah.hotel.model.ContactInfoType.CompanyName.class
})
