...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.book.model.RateAmountMessageType.Rates.Rate.class,
    com.tayyarah.api.hotel.travelguru.book.model.InvBlockRoomType.RatePlans.RatePlan.class
})
