...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.book.model.CompanyInfoType.PaymentForm.class,
    com.tayyarah.api.hotel.travelguru.book.model.CustomerType.PaymentForm.class,
    PaymentDetailType.class,
    com.tayyarah.api.hotel.travelguru.book.model.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class,
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<PaymentFormType.Ticket.ConjunctionTicketNbr> conjunctionTicketNbrs;
        ...
        /**
         * Gets the value of the conjunctionTicketNbrs property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the conjunctionTicketNbrs property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getConjunctionTicketNbrs().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<PaymentFormType.Ticket.ConjunctionTicketNbr> getConjunctionTicketNbrs() {
            if (conjunctionTicketNbrs == null) {
                conjunctionTicketNbrs = new ArrayList<PaymentFormType.Ticket.ConjunctionTicketNbr>();
            }
