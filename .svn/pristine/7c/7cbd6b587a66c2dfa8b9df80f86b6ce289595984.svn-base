...
@XmlSeeAlso({
    com.tayyarah.hotel.model.AreaInfoType.Attractions.Attraction.Contact.class,
    ContactInfoRootType.class,
    com.tayyarah.hotel.model.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class
})
