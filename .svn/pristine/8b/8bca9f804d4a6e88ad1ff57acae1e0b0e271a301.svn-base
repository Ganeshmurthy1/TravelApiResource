...
@XmlSeeAlso({
    com.tayyarah.hotel.model.ImageDescriptionType.Description.class,
    com.tayyarah.hotel.model.RateQualifierType.RateComments.RateComment.class,
    com.tayyarah.hotel.model.TextDescriptionType.Description.class,
    com.tayyarah.hotel.model.ParagraphType.ListItem.class
})
