...
@Author ilyas
19-dec-2015 
LintasFlightBookingResponseParser.java
 */
/**
 * 
 */
...
public class LintasFlightBookingResponseParser {	
	static Logger logger = Logger.getLogger(LintasFlightBookingResponseParser.class);
