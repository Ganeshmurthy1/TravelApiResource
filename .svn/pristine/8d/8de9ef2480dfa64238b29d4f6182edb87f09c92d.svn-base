...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.model.AllianceConsortiumType.AllianceMember.class,
    CompanyNamePrefType.class,
    OperatingAirlineType.class,
    com.tayyarah.api.hotel.travelguru.model.DirectBillType.CompanyName.class,
    TravelArrangerType.class,
    com.tayyarah.api.hotel.travelguru.model.ContactInfoType.CompanyName.class
})
