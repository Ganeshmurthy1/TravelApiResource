...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.model.CompanyInfoType.AddressInfo.class,
    com.tayyarah.api.hotel.travelguru.model.AddressesType.Address.class,
    com.tayyarah.api.hotel.travelguru.model.CustomerType.Address.class,
    com.tayyarah.api.hotel.travelguru.model.RequiredPaymentsType.GuaranteePayment.Address.class
})
