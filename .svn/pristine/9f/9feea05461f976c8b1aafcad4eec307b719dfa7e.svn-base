...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.model.AvailRequestSegmentsType.AvailRequestSegment.HotelSearchCriteria.class
})
    ...
    implements Serializable
{
	...
	public void setCriterions(List<HotelSearchCriteriaType.Criterion> criterions) {
