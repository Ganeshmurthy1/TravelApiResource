...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.model.AreaInfoType.Attractions.Attraction.Contact.class,
    ContactInfoRootType.class,
    com.tayyarah.api.hotel.travelguru.model.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class
})
