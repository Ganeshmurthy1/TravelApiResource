...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.book.model.CompanyInfoType.Email.class,
    com.tayyarah.api.hotel.travelguru.book.model.CustomerType.Email.class,
    com.tayyarah.api.hotel.travelguru.book.model.EmailsType.Email.class
})
