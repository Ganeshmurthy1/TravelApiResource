...
import com.tayyarah.flight.tempairsegment.dao.TempAirSegmentDAO;
...
public class DataBaseServices {
	...
	public  void isInternational(Flightsearch flightsearch, AirportDAO ADAO,CompanyDao cdao) {
		boolean isInternational=false;
		Set<String> countrySet=new HashSet<String>();
		if(flightsearch.getTripType().equalsIgnoreCase("M")){
			if(flightsearch.getTrips().equalsIgnoreCase("2")){
				try {
					String country=	ADAO.getyCountryName(flightsearch.getMFS().getDest1());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getDest2());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin1());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin2());
					countrySet.add(country);
					//NewDAO.InsertTAS(TAS);
				} catch (HibernateException e) {
					logger.error("HibernateException ",e);
					throw new FlightException(ErrorCodeCustomerEnum.HibernateException,ErrorMessages.NO_AIPRICE);
				}
				catch (Exception e) {logger.error("Exception ",e);
				throw new FlightException(ErrorCodeCustomerEnum.Exception,ErrorMessages.NO_AIPRICE);
				}
				...
				try {
					...
					country=	ADAO.getyCountryName(flightsearch.getMFS().getDest2());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getDest3());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin1());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin2());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin3());
					countrySet.add(country);
					//NewDAO.InsertTAS(TAS);
				} catch (HibernateException e) {
					logger.error("HibernateException ",e);
				...
				try {
					...
					country=	ADAO.getyCountryName(flightsearch.getMFS().getDest3());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getDest4());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin1());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin2());
					...
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin3());
					countrySet.add(country);
					country=	ADAO.getyCountryName(flightsearch.getMFS().getOrigin4());
					countrySet.add(country);
					//NewDAO.InsertTAS(TAS);
				} catch (HibernateException e) {
					logger.error("HibernateException ",e);
			...
			try {
				...
				String country=	ADAO.getyCountryName(flightsearch.getOrigin());
				countrySet.add(country);
				country=	ADAO.getyCountryName(flightsearch.getDestination());
				countrySet.add(country);
				//NewDAO.InsertTAS(TAS);
			} catch (HibernateException e) {
				logger.error("HibernateException ",e);
	...
	/*	public  String isInternational(Flightsearch flightsearch, AirportDAO ADAO) {
		String isInternational="YES";
		Set<String> countrySet=new HashSet<String>();
		...
		try{
			if(countrySet.size()>1){
				...
				isInternational=countrySet.iterator().next();
			}
	...
	public synchronized  void storeTempAirSegment(TypeBaseAirSegment typeBaseAirSegment, String ID, TempAirSegmentDAO tempDAO) {
		...
		try {
			...
			logger.error("Exception ",e);
			//throw new FlightException(ErrorCodeCustomerEnum.HibernateException,ErrorMessages.NO_FLIGHT);
		...
		//throw new FlightException(ErrorCodeCustomerEnum.Exception,ErrorMessages.NO_FLIGHT);
		}
	}

	public  void insertKeys(String transaction_key,String searchkey, TempAirSegmentDAO tempDAO) {
		//System.out.println("storeSearchFlightKeyMap")
	...
	public  void updateKeys(String transaction_key,String searchkey, TempAirSegmentDAO tempDAO) {
		//System.out.println("storeSearchFlightKeyMap")
		FlightBookingKeysTemp flightBookingKeys=new FlightBookingKeysTemp();
		flightBookingKeys.setSearch_key(searchkey);
		flightBookingKeys.setTransaction_key(transaction_key);
	...
	public  void insertPriceKey(String transaction_key,String price_key, TempAirSegmentDAO tempDAO) {
		try {
	...
	/*public  void insertCommission(FlightOrderRowCommission flightOrderRowCommission, FlightBookingDao FBDAO) {
		try {
	...
	public  void insertMarkupDetails(FlightOrderRowMarkup flightOrderRowMarkup, FlightBookingDao FBDAO) {
		try {
	...
	public  void storeSearchFlightKeyMap(UAPISearchFlightKeyMap uapiSearchFlightKeyMap,String transaction_key,String searchkey, TempAirSegmentDAO tempDAO) {

		//System.out.println("storeSearchFlightKeyMap");
		FlightSearchDetailsTemp searcdetails=new FlightSearchDetailsTemp();
		System.out.println("uapiSearchFlightKeyMap inside storeSearchFlightKeyMap :"+uapiSearchFlightKeyMap.getFareFlightSegmentMap().size());
		...
		try {
			...
			logger.error("HibernateException ",e);//throw new FlightException(ErrorCodeCustomerEnum.HibernateException,ErrorMessages.NO_FLIGHT);
		}catch (NumberFormatException e) {
			logger.error("NumberFormatException ",e);//throw new FlightException(ErrorCodeCustomerEnum.NumberFormatException,ErrorMessages.INVALID_APPKEY);
		}
		catch (Exception e) {
			logger.error("Exception ",e);
			//throw new FlightException(ErrorCodeCustomerEnum.Exception,ErrorMessages.NO_FLIGHT);
	...
	public  void UpdateSearchFlightKeyMap(UAPISearchFlightKeyMap uapiSearchFlightKeyMap,String transaction_key,String searchkey, TempAirSegmentDAO tempDAO) {
	...
	public  void storeFlightSearchApiResponses(String searchkey,byte[] FlightSearchResponse,TempAirSegmentDAO tempDAO,Flightsearch flightsearch,String apiProvider) {
		...
		/*	byte[] FSR = null;
		try {
			FSR = convertObjectToByteArray(tboFlightSearchResponse);
		} catch (IOException e1) {
			//System.out.println("uapiSearch");
			// TODO Auto-generated catch block
	...
	public  void storeAirPriceDetails(FlightPriceResponse flightPriceResponse,String pricekey,Flightsearch flightsearch, TempAirSegmentDAO tempDAO) {
	...
	//public  void storeTBOAirPriceDetails(FlightPriceResponse flightPriceResponse,String pricekey,Flightsearch flightsearch, TempAirSegmentDAO tempDAO,TboFlightAirpriceResponse tboFlightAirpriceResponse,TboFlightAirpriceResponse tboFlightAirpriceResponsespecial) {
	public  void storeTBOAirPriceDetails(FlightPriceResponse flightPriceResponse,String pricekey,Flightsearch flightsearch, TempAirSegmentDAO tempDAO,TboFlightAirpriceResponse tboFlightAirpriceResponse,TboFlightAirpriceResponse tboFlightAirpriceResponsespecial,String lowFareFlightIndex1,String lowFareFlightIndex2,String reason ,String lowFareFlightIndexReturn1,String lowFareFlightIndexReturn2,String reasonReturn) {
	...
	public  TempAirSegment getTempAirSegment(String flightindex, TempAirSegmentDAO tempDAO) {
	...
	@SuppressWarnings("finally")
	public  FlightSearchDetailsTemp getUAPISearchFlightKeyMap(String searchkey, TempAirSegmentDAO tempDAO) {
	...
	public  FlightSearchDetailsTemp getUAPISearchFlightKeyMapUsingTransactionkey (String transactionkey, TempAirSegmentDAO tempDAO) {
	...
	@SuppressWarnings("finally")
	public  FlightAirPriceDetailsTemp getAirPriceDetails(String pricekey, TempAirSegmentDAO tempDAO) {
	...
	public  void insertFlightSearchCacheApiResponses(FlightSearchCache flightSearchCache,TempAirSegmentDAO tempDAO) {	
