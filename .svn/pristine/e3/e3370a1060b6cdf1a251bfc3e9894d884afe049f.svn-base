 ...
 *       &lt;sequence>
 *         &lt;element name="ResGuest" type="{}ResGuestType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    protected List<ResGuestType> resGuests;
     ...
     * 
     */
    public List<ResGuestType> getResGuests() {
        if (resGuests == null) {
            resGuests = new ArrayList<ResGuestType>();
        }
