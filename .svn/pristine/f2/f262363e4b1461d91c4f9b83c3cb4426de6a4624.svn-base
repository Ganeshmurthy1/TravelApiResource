...
public class HotelBlockRequest {
     ...
     */
    public HotelBlockRequest(Integer ResultIndex, String HotelCode, String HotelName, String GuestNationality, Integer NoOfRooms, String ClientReferenceNo, Boolean IsVoucherBooking, List<HotelRoomsDetail> HotelRoomsDetails, String EndUserIp, String TokenId, String TraceId) {
