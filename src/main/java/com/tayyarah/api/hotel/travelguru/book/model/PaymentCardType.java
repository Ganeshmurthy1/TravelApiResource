...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.book.model.DonationType.CreditCardInfo.class
})
    ...
    implements Serializable
{
    ...
    protected List<PaymentCardType.Telephone> telephones;
    @XmlElement(name = "Email")
    protected List<EmailType> emails;
    @XmlElement(name = "CustLoyalty")
    protected List<PaymentCardType.CustLoyalty> custLoyalties;
     ...
     * 
     */
    public List<PaymentCardType.Telephone> getTelephones() {
        if (telephones == null) {
            telephones = new ArrayList<PaymentCardType.Telephone>();
        }
     ...
     * 
     */
    public List<PaymentCardType.CustLoyalty> getCustLoyalties() {
        if (custLoyalties == null) {
            custLoyalties = new ArrayList<PaymentCardType.CustLoyalty>();
        }
