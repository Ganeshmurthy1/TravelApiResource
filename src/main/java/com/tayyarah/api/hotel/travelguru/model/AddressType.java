...
@XmlSeeAlso({
    com.tayyarah.api.hotel.travelguru.model.DonationType.DonorInfo.ContactInfo.class,
    AddressInfoType.class,
    com.tayyarah.api.hotel.travelguru.model.ItemSearchCriterionType.Address.class
})
