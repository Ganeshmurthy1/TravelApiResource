    ...
    implements Serializable
{
    ...
    protected List<HotelPOI> hotelPOIs;

    /**
     * Gets the value of the hotelPOIs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hotelPOIs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHotelPOIs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<HotelPOI> getHotelPOIs() {
        if (hotelPOIs == null) {
            hotelPOIs = new ArrayList<HotelPOI>();
        }
