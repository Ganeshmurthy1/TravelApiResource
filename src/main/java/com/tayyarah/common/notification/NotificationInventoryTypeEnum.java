...
public enum NotificationInventoryTypeEnum {
	...
	CUSTOM_NOTIFICATION(18,"custom notification","notification item","notfication.png","notification"),
	
	HOTEL_CUSTOMER_PAYMENT_NOTIFICATION_ALERT(50, "hotel customer payment notification", "hotel customer payment notification alert","walletalert.png","addCustomerPaymentTransaction"),
	HOTEL_SUPPLIER_PAYMENT_NOTIFICATION_ALERT(51, "hotel supplier payment notification", "hotel supplier payment notification alert","walletalert.png","addApiProviderPaymentTransaction"),
