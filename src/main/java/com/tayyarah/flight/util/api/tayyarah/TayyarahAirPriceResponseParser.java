...
public class TayyarahAirPriceResponseParser {	
	static Logger logger = Logger.getLogger(TayyarahAirPriceResponseParser.class);
	...
	private static void addGSTSpecial(FlightPriceResponse flightPriceResponse,BigDecimal totalprice,BigDecimal Markup){
		...
		GST=Markup.multiply(GSTinpercentage).divide(new BigDecimal("100"));
	...
	private static void addGST(FlightPriceResponse flightPriceResponse){
