...
@XmlSeeAlso({
    com.tayyarah.hotel.model.DonationType.DonorInfo.ContactInfo.class,
    AddressInfoType.class,
    com.tayyarah.hotel.model.ItemSearchCriterionType.Address.class
})
    ...
    implements Serializable
{
	...
	/**
	 * @param bldgRooms the bldgRooms to set
	 */
