 ...
 *         &lt;element name="ApiAmountPercent" type="{http://www.opentravel.org/OTA/2003/05}AmountPercentType" minOccurs="0"/>
 *         &lt;element name="BaseAmountPercent" type="{http://www.opentravel.org/OTA/2003/05}AmountPercentType" minOccurs="0"/>
 *         &lt;element name="BaseWithoutMarkupAmountPercent" type="{http://www.opentravel.org/OTA/2003/05}AmountPercentType" minOccurs="0"/>
 *         &lt;element name="PenaltyDescription" type="{http://www.opentravel.org/OTA/2003/05}PenaltyDescription" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "CancelPenaltyType", propOrder = {
    ...
    "apiAmountPercent",
    "baseAmountPercent",
    "baseWithoutMarkupAmountPercent",
    "penaltyDescriptions"
})
    ...
    implements Serializable
{
	...
	public AmountPercentType getApiAmountPercent() {
		return apiAmountPercent;
	}

	public void setApiAmountPercent(AmountPercentType apiAmountPercent) {
		this.apiAmountPercent = apiAmountPercent;
	}

	public AmountPercentType getBaseAmountPercent() {
		return baseAmountPercent;
	}

	public void setBaseAmountPercent(AmountPercentType baseAmountPercent) {
		this.baseAmountPercent = baseAmountPercent;
	}

	public AmountPercentType getBaseWithoutMarkupAmountPercent() {
		return baseWithoutMarkupAmountPercent;
	}

	public void setBaseWithoutMarkupAmountPercent(
			AmountPercentType baseWithoutMarkupAmountPercent) {
		this.baseWithoutMarkupAmountPercent = baseWithoutMarkupAmountPercent;
	}
	...
	/**
	 * @param penaltyDescriptions the penaltyDescriptions to set
	 */
	public void setPenaltyDescriptions(List<PenaltyDescription> penaltyDescriptions) {
    ...
    @XmlElement(name = "ApiAmountPercent")
    protected AmountPercentType apiAmountPercent;
    @XmlElement(name = "BaseAmountPercent")
    protected AmountPercentType baseAmountPercent;   
    @XmlElement(name = "BaseWithoutMarkupAmountPercent")
    protected AmountPercentType baseWithoutMarkupAmountPercent;
   
    
    @XmlElement(name = "PenaltyDescription")
    protected List<PenaltyDescription> penaltyDescriptions;
     ...
     * 
     */
    public List<PenaltyDescription> getPenaltyDescriptions() {
        if (penaltyDescriptions == null) {
            penaltyDescriptions = new ArrayList<PenaltyDescription>();
        }
