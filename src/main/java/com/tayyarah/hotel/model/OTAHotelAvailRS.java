...
implements Serializable
{
	...
	public String toString() {
		return "OTAHotelAvailRS [pos=" + pos + ", success=" + success
				+ ", warnings=" + warnings + ", hotelStays=" + hotelStays
				+ ", roomStays=" + roomStays + ", services=" + services
				+ ", areas=" + areas + ", criteria=" + criteria
				+ ", currencyConversions=" + currencyConversions
				+ ", rebatePrograms=" + rebatePrograms + ", tpaExtensions="
				+ tpaExtensions + ", errors=" + errors + ", searchCacheLevel="
				+ searchCacheLevel + ", correlationID=" + correlationID
				+ ", echoToken=" + echoToken + ", retransmissionIndicator="
				+ retransmissionIndicator + ", sequenceNmbr=" + sequenceNmbr
				+ ", target=" + target + ", targetName=" + targetName
				+ ", timeStamp=" + timeStamp + ", transactionIdentifier="
				+ transactionIdentifier + ", transactionStatusCode="
				+ transactionStatusCode + ", version=" + version
				+ ", altLangID=" + altLangID + ", primaryLangID="
				+ primaryLangID + ", additionalAgencyInfo="
				+ additionalAgencyInfo + "]";
	}
	...
	/*
    Additional Agency information added by Intellicomm
	 */
	@XmlAttribute(name = "PrimaryLangID")
	protected AdditionalAgencyInfo additionalAgencyInfo;
	...
	implements Serializable
	{
		...
		protected List<OTAHotelAvailRS.CurrencyConversions.CurrencyConversion> currencyConversions;
		 ...
		 * not a snapshot. Therefore any modification you make to the
		 * returned list will be present inside the JAXB object.
		 * This is why there is not a <CODE>set</CODE> method for the currencyConversions property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * <pre>
		 *    getCurrencyConversions().add(newItem);
		 * </pre>
		 * 
		 * 
		 * <p>
		 ...
		 * 
		 */
		public List<OTAHotelAvailRS.CurrencyConversions.CurrencyConversion> getCurrencyConversions() {
			if (currencyConversions == null) {
				currencyConversions = new ArrayList<OTAHotelAvailRS.CurrencyConversions.CurrencyConversion>();
			}
	...
	implements Serializable
	{
		...
		implements Serializable
		{
			...
			protected List<OTAHotelAvailRS.HotelStays.HotelStay.Price> prices;
			@XmlElement(name = "TPA_Extensions")
			protected TPAExtensions tpaExtensions;
			 ...
			 * 
			 */
			public List<OTAHotelAvailRS.HotelStays.HotelStay.Price> getPrices() {
				if (prices == null) {
					prices = new ArrayList<OTAHotelAvailRS.HotelStays.HotelStay.Price>();
				}
				return this.prices;
			}
	...
	implements Serializable
	{
		...
		/**
		 * @param roomStaies the roomStaies to set
		 */
		public void setRoomStaies(List<OTAHotelAvailRS.RoomStays.RoomStay> roomStaies) {
			this.roomStaies = roomStaies;
		}
		...
		implements Serializable
		{
			...
			@Valid
			List<RoomCombinations> roomGroups;			
			@JsonIgnore			
			HotelSearchCity city;		
			@JsonProperty("SupplierRoomGroups")
			@Valid
			List<RoomCombinations> supplierRoomGroups;
			...
			public List<RoomCombinations> getRoomGroups() {
				return roomGroups;
			}

			public void setRoomGroups(List<RoomCombinations> roomGroups) {
				this.roomGroups = roomGroups;
			}

			public List<RoomCombinations> getSupplierRoomGroups() {
				return supplierRoomGroups;
			}

			public void setSupplierRoomGroups(List<RoomCombinations> supplierRoomGroups) {
				this.supplierRoomGroups = supplierRoomGroups;
			}			
