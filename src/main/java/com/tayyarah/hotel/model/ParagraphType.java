...
@XmlSeeAlso({
    ...
    com.tayyarah.hotel.model.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.tayyarah.hotel.model.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class,
    com.tayyarah.hotel.model.ProfileType.Comments.Comment.class,
    com.tayyarah.hotel.model.CommentType.Comment.class,
    com.tayyarah.hotel.model.SpecialRequestType.SpecialRequest.class,
    com.tayyarah.hotel.model.InvBlockType.BlockDescriptions.BlockDescription.class
})
    ...
    implements Serializable
{
    ...
    public List<JAXBElement<? extends Serializable>> getUrlsAndListItemsAndImages() {
		return urlsAndListItemsAndImages;
	}

	public void setUrlsAndListItemsAndImages(
			List<JAXBElement<? extends Serializable>> urlsAndListItemsAndImages) {
		this.urlsAndListItemsAndImages = urlsAndListItemsAndImages;
	}
