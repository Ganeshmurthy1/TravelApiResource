...
@XmlSeeAlso({
    com.tayyarah.hotel.model.RoomStayType.RoomRates.RoomRate.class
})
    ...
    implements Serializable
{
    ...
    protected Integer apiProvider;
    
    
    
  /*  @XmlAttribute(name = "ApiBookingCode")
    protected String apiBookingCode;
...
*/
	...
	public Integer getRoomReqIndex() {
		return roomReqIndex;
	}

	public void setRoomReqIndex(Integer roomReqIndex) {
		this.roomReqIndex = roomReqIndex;
	}
	...
	public void setHotelSupplements(List<String> hotelSupplements) {
	...
	public void setRoomRateDescriptions(List<ParagraphType> roomRateDescriptions) {
		this.roomRateDescriptions = roomRateDescriptions;
	}

	public void setAvailabilities(List<RoomRateType.Availability> availabilities) {
	...
	@JsonProperty("RoomReqIndex")
    private Integer roomReqIndex;   
    
    @JsonProperty("SupplierRoomIndex")
    private Integer supplierRoomIndex;   
    
    
    public Integer getSupplierRoomIndex() {
		return supplierRoomIndex;
	}

	public void setSupplierRoomIndex(Integer supplierRoomIndex) {
		this.supplierRoomIndex = supplierRoomIndex;
	}

	
	@JsonProperty("SupplierHotelCode")
    ...
    @Valid
    private List<String> hotelSupplements = new ArrayList<String>();
	...
	public boolean isRateAssociated() {
		return isRateAssociated;
	}

	public void setRateAssociated(boolean isRateAssociated) {
